...
<blockquote class="ma-social-quote"><p lang="en" dir="ltr">Hey maybe the reason why accessibility is getting worse and the web is breaking is because folks still think that writing CSS and HTML is “lite” coding.<br><br>Hey maybe the way we fix the web is by paying front-end engineers the same as full-stack engineers.</p>&mdash; Robin Rendle (@robinrendle) <a href="https://twitter.com/">May 9, 2019</a></blockquote>
...
<figure>
  {% image "omaha-beach.gif", "A scene from Saving Private Ryan where medics work to save a soldier on Omaha beach." %}
<figcaption>
