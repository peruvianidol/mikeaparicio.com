...
<style>
  ...
  .demo-layout > [data-grid-area="left"] {
    background-color: #1F1E25;
  }
  .demo-layout > [data-grid-area="right"] {
    background-color: #16151A;
    min-height: 526px;
    padding: 2rem;
  }
  .demo-layout > [data-grid-area="right"] > :not(:last-child) {
...
<section class="demo-layout">
  <nav class="nav-list-demo" id="example" data-grid-area="left">
