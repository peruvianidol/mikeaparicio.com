...
<figure class="ma-float-center">
  {% image "ryan-portrait.jpg", "Cute baby alert" %}
  <figcaption>
    Ryan
  </figcaption>
</figure>
...
<figure class="ma-float-right">
  {% image "with-scott.jpg", "Scott, Ryan and me" %}
  <figcaption>
...
<figure>
  {% image "bball-champs.jpg", "Buncha sweaty dudes acting hard" %}
  <figcaption>
...
<figure>
  {% image "the-lighthouse.jpg", "Robert Pattinson and Willem Dafoe in The Lighthouse" %}
  <figcaption>
...
<figure class="ma-float-right">
  {% image "baby-yoda.gif", "Baby Yoda sipping from a cup" %}
<figcaption>
...
<figure>
  {% image "nba2k20-mycareer.jpg", "Post-game team shot" %}
  <figcaption>
...
<figure>
  {% image "xmas2019.jpg", "Mike and his family with Santa Claus" %}
  <figcaption>
