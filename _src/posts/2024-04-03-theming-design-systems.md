...
```scss
.pv-surface-brand {
  background-color: var(--color-surface-brand, #{$color-surface-brand});
}
```

We're using the `var()` function to set the background color to the custom property, `--color-surface-brand` and, if it's not set, it will fall back to the value of the token `$color-surface-brand` from our Sass tokens. This will compile to:

```css
.pv-surface-brand {
  background-color: var(--color-surface-brand, #02363D);
}
```
...
<style style="display: block" contenteditable>:root {
  ...
  --color-surface-body: #F7F5F0;
  --color-surface-brand: #7A0612;
  --color-surface-elevated: #ECEAE3;
  --color-surface-card: #FFFFFF;
  --color-text-body: #16161A;
  --color-text-subdued: #6B6964;
  --color-text-interactive: #DA1025;
  --color-text-interactive-hover: #16161A;
  --color-text-accent: #92721C;
}
@media (prefers-color-scheme: dark) {
  :root {
    --color-surface-body: #1f1f1f;
    --color-surface-brand: #8c1428;
    --color-surface-elevated: #303030;
    --color-surface-card: #141413;
    --color-text-body: #f1f1f1;
    --color-text-subdued: #ababab;
    --color-text-interactive: #FF5A5C;
    --color-text-interactive-hover: currentColor;
