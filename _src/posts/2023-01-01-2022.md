...
<figure class="ma-float-left">
  <video controls>
    <source src="/assets/images/ryan-mario.mp4"
            type="video/mp4">
  </video>
  <figcaption>
    It's a me, Ryan!
...
<figure class="ma-float-right">
  <video controls>
    <source src="/assets/images/bathroom-renovation.mp4"
            type="video/mp4">
  </video>
</figure>
...
<figure>
  <iframe src="https://www.youtube.com/embed/79IEesucPo8?si=5rz0N6s2qEjWRV8Z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
