...
<figure>
  <video poster="/assets/images/pain-box.png" src="/assets/images/pain-box.mp4" loop autoplay muted playsinline>
</figure>
...
<figure>
  ...
  <figcaption class="ma-text-sm">* or, you know, quit tech and start a Peruvian food truck business, which goes great until your spouse divorces you because you took such a massive pay cut and you're working all the time, never see the kids, and come home smelling like ceviche. Hypothetically.</figcaption>
</figure>

Despite the latest advancements in CSS, many are  still stuck in this kind of [BEM](https://getbem.com) mindset, trying to perfectly encapsulate everything so we don't end up with unexpected results when we make changes.
...
I've included it in a `:where()` [pseudo-class function](https://developer.mozilla.org/en-US/docs/Web/CSS/:where) to reduce its specificity to zero so that you could override the bottom margin of any of the children with another utility class if needed.
