...
I had seen an article on using Design Mode in Eleventy, which was a feature I didn't even know was a thing. It basically makes a whole page behave as if `contenteditable` were enabled.
