...
Between [switching jobs](https://www.mikeaparicio.com/posts/2020-07-23-goodbye-groupon/) and starting [a bunch](https://11ty.recipes/) of [side-projects](https://dogsof.dev/), I've found myself re-writing a lot of CSS in the past year. Wouldn't it be nice, I thought, if I could just write one CSS framework and use it on any project? **[cool.css](https://github.com/peruvianidol/coolcss)** is my attempt to do just that.
...
<figure>
  <video preload="auto" aria-label="Embedded video" src="/assets//images/coolcss.mp4" poster="/assets/images/coolcss.jpg" type="video/mp4" playsinline autoplay disablePictureInPicture loop muted></video>
